...
import static seedu.address.logic.commands.CommandTestUtil.VALID_CLIENTSTATUS_AMY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_CLIENTSTATUS_BOB;
...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withClientStatus(VALID_CLIENTSTATUS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withRelationship(VALID_RELATIONSHIP_BOB)
            .withClientStatus(VALID_CLIENTSTATUS_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
